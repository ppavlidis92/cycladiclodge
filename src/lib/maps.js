...
export function getGoogleMapsPlaceUrl(language = "en") {
  const mapLanguage = language === "el" ? "el" : "en";

  return `https://www.google.com/maps/search/?api=1&query=Cycladic%20Lodge%20Sifnos%2C%20Katavati%2C%20Sifnos&hl=${mapLanguage}`;
}
